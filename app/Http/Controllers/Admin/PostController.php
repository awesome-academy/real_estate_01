...
//        $categories = DB::table('categories')->pluck('name', 'id')->all();
    ...
    public function store(PostFormRequest $request)
    {
        ...
        return redirect('/posts/create')->with('success', trans('post.create_post_success'));
    }
...
//        $categories = DB::table('categories')->pluck('name', 'id')->all();
    ...
    public function destroy($id)
    {
        ...
        return redirect('/posts')->with('success', trans('post.delete_post_success', ['name' => $post->title]));
    }
