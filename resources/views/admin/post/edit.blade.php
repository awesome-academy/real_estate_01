        ...
        <div class="page-title">
            ...
            <div class="title_right">
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{ route('posts.index') }}">__('list_post')</a></li>
                    <li class="active">__('edit_post')</li>
                </ol>
            </div>
        </div>
                                ...
                                <a href="javascript:open_popup('{{ config('common.filemanager') }}dialog.php?type=1&popup=1&field_id=fieldID')"
                                   class="thumbnail size_img">
                                    <img class="imagePreview"
                                         src="{!! $actual_link . config('common.image_upload') . $post->image !!}"
                                         alt="">
                                </a>
                                <input id="fieldID" type="hidden"
                                       value="{!! $actual_link . config('common.image_upload') . $post->image !!}"
